...
import { styleFeature as styleFeatureUtil, countryFlag } from './utils.js';
...
function styleFeature(feature) {
  return styleFeatureUtil(visitedSet, feature);
}
...
for (const feature of visitedFeatures) {
  ...
  item.innerHTML = `${countryFlag(code)} ${feature.properties.name}`;
